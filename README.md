...
# Ανάλυση Κώδικα / Σχεδιαστικές Επιλογές / Flowchart Αλγορίθμου
...
1. Συνάρτηση `FindMedoid()`, για την εύρεση του ενδιάμεσου στοιχείου του συνόλου P, που παράγεται από την συνάρτηση
